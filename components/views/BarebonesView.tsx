      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        {activeSection === "about" && (
          <section className="space-y-6">
            ...
            <p className="text-david-gray leading-relaxed">
              ...
              adaptable 4th year student with a passion for emerging
              technologies in Artificial Intelligence and financial markets,
              driven to make a meaningful impact in the world of technology.
            </p>
          ...
          <section className="space-y-6">
            ...
            <div className="grid gap-4">
              <div className="p-4 bg-white/50 border border-david-gray/20 rounded-lg">
                <h3 className="text-david-blue font-semibold mb-2">
                  3D Portfolio Experience
                </h3>
                <p className="text-david-gray text-sm mb-2">
                  Interactive 3D room built with Three.js and React. Toggle
                  &quot;3D&quot; in the header to try it.
                </p>
        ...
        {activeSection === "contact" && (
          <section className="space-y-6">
            ...
            <p className="text-david-gray leading-relaxed">
              Let&apos;s collaborate on something amazing. Whether you have a
              project in mind or just want to chat about technology and
              creativity.
            </p>
            <div className="space-y-3">
              <a
                href="mailto:davidcedricctan@gmail.com"
              ...
              >
                ...
                <span className="text-david-blue">
                  davidcedricctan@gmail.com
                </span>
              </a>
              <a
              ...
              >
                ...
                <span className="text-david-blue">
                  github.com/david-cedric-tan
                </span>
              </a>
              <a
                href="https://www.linkedin.com/in/david-cedric-t-45a74318b"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 p-3 bg-white/50 border border-david-gray/20 rounded-lg hover:border-david-teal/50 transition-colors"
              >
                ...
                <span className="text-david-blue">
                  www.linkedin.com/in/davidcedricctan
                </span>
              </a>
            </div>
          </section>
